function problemOne() {
  ...
  let mini = findMin(num1, num2, num3, num4, num5, num6);
  let average = (num1 + num2 + num3 + num4 + num5 + num6 - mini)/5;
...
function problemTwo() {
  ...
  //Compute the GPA.
  let GPA = findGPA(grade1, grade2, grade3, grade4, grade5, grade6);
